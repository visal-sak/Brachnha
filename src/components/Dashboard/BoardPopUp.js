            ...
            <section className="mb-10 grid grid-cols-1 gap-1">
              <div class="col-span-1">
                <img
                  src={imageUrl}
                  alt="football"
                  class="w-36 xl:w-48 object-cover"
                />
              </div>
            </section>
            <section>
              ...
              <section className="grid grid-cols-3 md:grid-cols-3 gap-48">
                {values.answerWord.map((word) => (
                  <section class="col-span-1">
                    <article class="inline-block align-bottom md:mx-3">
                      <button class="btn btn-outline text-lg btn-secondary text-black lg:w-24 lg:h-16 bg-slate-50">
                        {word}
                      </button>
                    </article>
                  </section>
