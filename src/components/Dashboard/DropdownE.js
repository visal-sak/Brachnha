...
const DropdownE = () => {
  ...
  return (
    <div className="relative">
      <button
        className="flex items-center p-2 text-white rounded-lg hover:bg-fuchsia-400 dark:hover:bg-fuchsia-400 hover:text-gray-800"
      ...
      {isOpen && (
        <>
          <Link
            href="/dashboard/editor/dragdropgame"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
              pathname === "/dashboard/editor/dragdropgame"
                ...
                : "bg-transparent"
            } hover:bg-fuchsia-400 dark:hover:bg-fuchsia-400`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <Link
            href="/dashboard/editor/countgame"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
          ...
          <Link
            href="/dashboard/editor/multiplegame"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
          ...
          <Link
            href="/dashboard/editor/gameformop"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
          ...
          <Link
            href="/dashboard/editor/gamecompare"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
