  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <>
          <Link
            href="/dashboard/superadmin/dragdropgame"
          ...
          <Link
            href="/dashboard/superadmin/countgame"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
          ...
          <Link
            href="/dashboard/superadmin/multiplegame"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
          ...
          <Link
            href="/dashboard/superadmin/gameformop"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
          ...
          <Link
            href="/dashboard/superadmin/gamecompare"
            class={`flex items-center my-3 p-2 text-white rounded-lg ${
