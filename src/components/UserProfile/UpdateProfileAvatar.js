...
export default function FormUpdateProfileAvatar({ uuid }) {
  ...
  return (
    <>
      <button
        ...
        class="left-2 bottom-1 absolute w-32 h-32  border my-3 border-transparent hover:bg-transparent  focus:outline-none  font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2"
      ></button>
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-sm md:text-base xl:text-xl font-semibold text-gray-900">
                កែសម្រួល Profile
              </h3>
              <button
                type="button"
                className="text-purple-400 hover:text-purple-500 focus:outline-none px-5"
                onClick={() => setIsModalVisible(false)}
              >
            ...
            {isLoading ? (
              ...
              <Formik
                ...
                onSubmit={async (values, { setSubmitting, resetForm }) => {
                  ...
                  const profile = await uploadImage({ file: formData });
                ...
                {({ formik }) => (
                  <Form className="flex flex-col">
                    ...
                    <div class="flex items-center justify-center w-full">
                      <label
                        for="dropzone-file"
                        class="flex  relative flex-col items-center justify-center w-full sm:w-2/3 md:w-3/4 lg:w-2/3 xl:w-2/3 h-32 sm:h-48 md:h-32 lg:h-64 xl:h-64 border-2 border-gray-300 border-dashed rounded-full cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                      >
                    ...
                    <div className="form-actions mt-4 flex flex-col md:flex-row md:justify-between">
                      ...
                      <div className="dropdown-menu md:hidden"></div>
                    </div>
                  </Form>
                )}
              </Formik>
