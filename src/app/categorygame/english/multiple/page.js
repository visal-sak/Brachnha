...
import MultipleChoiceEnglish from "src/components/GameCard/English/multipleChoice";
import { Howl } from "howler";

export default function EnglishMultiplePageGame() {
        useEffect(() => {
  ...
  return (
    <>
      <main className="w-full bg-englishCard">
        <section className="flex-wrap flex items-center justify-evenly p-24">
          <Link href="/typegame/english">
            <button
              type="button"
              class="text-black bg-emerald-400 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-full text-lg p-2.5 lg:p-5 md:text-lg md:p-4 text-center inline-flex items-center mr-2 dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800"
            >
              <svg
