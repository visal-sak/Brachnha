...
import MultipleChoiceKhmer from "../../../../components/GameCard/Khmer/multipleChoice";
      ...
      <main className="w-full bg-khmerCard">
        <section className="flex-wrap flex items-center justify-evenly p-24 overflow-x-auto">
          <Link href="/typegame/khmer">
            <button
              type="button"
              class="text-black bg-fuchsia-400 hover:bg-fuchsia-800 focus:ring-4 focus:outline-none focus:ring-fuchsia-300 font-medium rounded-full text-lg p-2.5 lg:p-5 text-center inline-flex items-center mr-2 dark:bg-fuchsia-600 dark:hover:bg-fuchsia-700 dark:focus:ring-fuchsia-800"
            >
              <svg
