import CountByTenPattern from "../../../components/PartternGame/countbyten";
import React from 'react'
import Link from 'next/link';

export default function CountByTenPage() {
  return (
    <>
      <main className="w-full bg-countTenMath">
        <section className="flex-wrap flex items-center justify-evenly p-24">
          <Link href="/categorygame/math/count">
            <button
              type="button"
              class="text-black bg-cyan-400 hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800"
            >
              <svg
