...
import DrugDropEnglishPattern from '../../../components/PartternGame/drugDropEnglish';

export default function DrugDropGame() {
  return (
    <>
      <main className="w-full bg-DrugDropEng">
        <section className="flex-wrap flex items-center justify-evenly p-24">
          <Link href="/categorygame/english/drugdrop">
            <button
              type="button"
