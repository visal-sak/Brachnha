...
import Rain from "../../../utils/assets/leavef.json";
...
export default function IncorrectAnswerPage({ params }) {
  ...
  return (
    <>
      <main className="w-full bg-land">
        <img
          src="../../../images/frog.png"
          alt="land"
          className=" w-28 md:w-24 lg:w-32 xl:w-56 absolute left-5 -bottom-64 md:left-10 md:-bottom-40 lg:left-5 lg:-bottom-64 xl:bottom-16 xl:left-20 xl:top-full bounce"
        />
        <img
          src="../../../images/beeMaya.png"
          alt="land"
          className=" w-20 md:w-28 lg:w-32 xl:w-36 absolute left-5 top-36 md:left-10 md:bottom-40 lg:left-5 lg:bottom-12 xl:bottom-16 xl:left-20 xl:top-36 animationFlyFull"
        />
        <Lottie
          animationData={Rain}
          alt="land"
        ...
        />
        <img
          src="../../../images/roseAurora.png"
          alt="land"
          className="left-48 -bottom-64 md:right-3 md:-bottom-44 xl:right-36 absolute w-24 md:w-36 lg:w-48 lg:-bottom-56 xl:w-52 xl:bottom-20 xl:top-full bounce"
        />
        <img
          src="../../../images/rabbits.png"
          alt="land"
          className="right-9 -bottom-80 md:right-40 md:-bottom-56 xl:right-96 absolute w-36 md:w-36 lg:w-48 lg:-bottom-44 xl:w-52 xl:top-full bounce"
        />
        <section className="flex-wrap flex items-center justify-evenly p-24">
          ...
          <article className="my-56 left-10 md:left-2/3 lg:left-2/3 mb-0 md:my-0 lg:my-0 lg:top-96 xl:mb-24 xl:my-0 xl:left-2/3 absolute">
            <button
              type="button"
              onClick={handleRoute}
              class="text-white bg-cyan-500 hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-full lg:text-xl xl:text-xl text-sm p-2.5 xl:p-4 text-center inline-flex items-center mr-2 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800"
            >
              <svg
