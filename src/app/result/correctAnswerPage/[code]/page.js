...
import {
  ...
  useGetUserQuery,
} from "src/store/features/user/userApiSlice";
...
import ButterflyAnimeAlien from "../../../utils/assets/alien.json";
...
export default function CorrectAnswerPage({ params }) {
  ...
  useEffect(() => {
    const postData = async () => {
      try {
        // Check if the postGameHistory mutation has already been executed during the current session
        const hasPostedGameHistory = localStorage.getItem(
          "hasPostedGameHistorys"
        );
...
const handleRoute = () => {
  ...
  setTimeout(() => {
    // Navigate to the new route after the delay
...
useEffect(() => {
  ...
  return (
    <>
      <main className="w-full bg-correctPage">
        <img
          src="../../../images/blue.png"
          alt="land"
          className=" w-24 md:w-28 lg:w-36 xl:w-40 absolute left-5 top-[750px] md:left-20 md:bottom-24 lg:left-5 lg:bottom-12 xl:bottom-16 xl:left-36 xl:top-[500px] bounce"
        />
        <Lottie
          animationData={ButterflyAnimeAlien}
          alt="land"
          className=" w-24 md:w-24 lg:w-24 xl:w-56 absolute left-5 top-36 md:left-10 md:bottom-40 lg:left-5 lg:bottom-12 xl:bottom-16 xl:left-40 xl:-top-10"
        />
        <Lottie
        ...
        <img
          src="../../../images/toy.png"
          alt="land"
          className="left-[280px] bottom-96 md:left-72 md:top-24 xl:right-36 absolute md:bottom-1 w-20 md:w-36 lg:w-36 xl:w-40 xl:bottom-28 xl:top-44 xl:left-[1200px] animationFly"
        />
        <img
